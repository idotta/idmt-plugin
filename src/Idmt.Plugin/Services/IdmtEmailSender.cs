...
public sealed class IdmtEmailSender(ILogger<IdmtEmailSender> logger) : IEmailSender<IdmtUser>
{
    public Task SendConfirmationLinkAsync(IdmtUser user, string email, string confirmationLink)
    {
    ...
    public Task SendPasswordResetCodeAsync(IdmtUser user, string email, string resetCode)
    {
    ...
    public Task SendPasswordResetLinkAsync(IdmtUser user, string email, string resetLink)
    {
